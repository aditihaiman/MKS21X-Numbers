public class Driver2 {
  ...
  public static void main(String[] args) {
    ...
    // Mixing rational and real numbers
    RealNumber r = new RealNumber(4.5);
    RationalNumber e = new RationalNumber(-1, -2);

    System.out.println(e); // Should print 1/2
    System.out.println(e.add(r)); //Should print 5.0
    System.out.println(r.add(e)); //Should print 5.0
    System.out.println(e.divide(r)); //Should print 0.1111111...
    System.out.println(r.divide(e)); //Should print 9.0
    System.out.println(r.multiply(e)); //Should print 2.25
    System.out.println();
    System.out.println();
  }
